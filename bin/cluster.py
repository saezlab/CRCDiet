...
for l_param in np.arange(0.25, 1.0, 0.05):
    ...
    sc.pl.umap(adata, color=[f"leiden_{l_param:.2f}"], palette=sc.pl.palettes.default_20, show=False, save=f'res-{l_param:.2f}_silh-{silh_scr:.3f}_clusters')
    break
